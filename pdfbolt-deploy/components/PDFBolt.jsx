...
function dl(u,n){
  ...
  try {
    ...
    if(u.startsWith("data:")){
      const parts=u.split(",");const mime=parts[0].match(/:(.*?);/)[1];
    ...
    if(blob){
      ...
      const a=document.createElement("a");a.href=blobUrl;a.download=n;a.style.display="none";
      document.body.appendChild(a);a.click();
      setTimeout(()=>{document.body.removeChild(a);URL.revokeObjectURL(blobUrl)},500);
    } else {
      // Fallback for non-data URLs
      const a=document.createElement("a");a.href=u;a.download=n;a.style.display="none";
      document.body.appendChild(a);a.click();
